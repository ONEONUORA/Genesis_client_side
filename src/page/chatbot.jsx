    ...
    return(
        ...
        <section className="flex h-screen flex-col items-center justify-center">
          <h1 className="mb-5 text-center text-[24px] font-bold">
               A Safe Space to Seek Help and Find Hope
          </h1>
          ...
          <div className="w-[40rem] rounded-lg bg-white p-[2rem] shadow-lg">
            ...
            <div className="flex flex-col items-center">
              ...
              <button className="h-[45px] w-[8rem] rounded-[12px] bg-blue-700 p-[12px] text-center text-[16px] font-[700] leading-[20.8px] text-white">
                Genesis
              </button>
            </div>
          </div>
